...
const images = [
	...
	"/images/core-product/budapest-1.jpg",
	"/images/core-product/budapest-hungary.jpg",
	"/images/core-product/budapest-turism.jpg",
				...
				<div className="CoreProduct__detail">
					...
					<div className="CoreProduct__detail-more">
						...
						<div className="CoreProduct__detail-more--item">
							<Link
								href={
									"https://info.globalliving-group.com/hungary?fbclid=IwAR2rHda4MrVN0JRTsLEdAqIiSteJ45oWJ3hZ4IlMk-piL1GZsO5Il4_QY18"
								}
								target="_blank"
								className="price"
							>{`Tìm hiểu thêm >>`}</Link>
