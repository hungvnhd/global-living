			...
			<div className="inner">
				...
				<div className="department">
					<div className="department-box">
						...
						<p>
							TOONG TRÀNG THI - Số 8 Tràng Thi Hàng Trống - Quận
							Hoàn Kiếm - HÀ NỘI
						</p>
					</div>
					...
					<div className="department-box text-center">
						...
						<p>
							COWORK GOLD COAST - Tầng 9, Toà nhà Gold Coast - Số
							1 Trần Hưng Đạo, P. Lộc Thọ, TP NHA TRANG
						</p>
					</div>
					...
					<div className="department-box">
						...
						<p>
							SUNWAH INNOVATIONS - Tầng 6 - Tháp Golden - Toà nhà
							Sunwah Pearl 90 Nguyễn Hữu Cảnh - Phường 2, Quận
